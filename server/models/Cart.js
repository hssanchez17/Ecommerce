...
class Cart{
	...
	registerAProduct(userId,productId,quantity){
	...
	removeAllProductsFromAllCartsForDestructionOfAProduct(productId){
		return new Promise((resolve, reject) => {
			const query= 'DELETE FROM carts WHERE productId=$1'
